...
export function AdminShell({
      ...
      >
        <Box
          sx={{
            ...
            color: "#fff",
            fontWeight: 900,
            boxShadow: "0 8px 24px rgba(139,125,255,.35)",
          }}
        >
          S
        </Box>
        <Box>
          <Typography fontWeight={800}>SMARTS</Typography>
  ...
  const title =
    view === "player360"
      ...
      : view === "match360"
        ? "Match 360"
        : (navigation.find((item) => item.key === view)?.label ?? "Overview");
  return (
    <Box
      sx={{
        minHeight: "100vh",
        display: "flex",
        background:
          "radial-gradient(circle at 75% -15%, rgba(72,82,159,.45), transparent 32%), #0b1020",
      }}
    >
      <Box
        component="nav"
      ...
      <Drawer
        ...
        sx={{
          ...
          "& .MuiDrawer-paper": { bgcolor: "background.paper" },
        }}
      >
        {drawer}
      </Drawer>
      <Box component="main" sx={{ minWidth: 0, flex: 1 }}>
        ...
        >
          ...
          <Stack direction="row" spacing={1.5} alignItems="center">
            ...
            >
              <Typography fontWeight={700}>{adminName}</Typography>
              <Typography variant="caption" color="text.secondary">
                Administrator
              </Typography>
            </Box>
