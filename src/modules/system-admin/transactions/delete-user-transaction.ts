...
@Injectable()
export class DeleteUserTransaction extends PrismaTransaction<{ userId: string; actorId: string }, void> {
  constructor(prisma: PrismaService) {
    super(prisma)
  }

  protected async execute(data: { userId: string; actorId: string }, transaction: Prisma.TransactionClient) {
