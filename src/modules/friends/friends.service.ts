...
export class FriendsService {
  ...
  private userSelect() { return { id: true, username: true, email: true, createdAt: true, profile: { select: { displayName: true, avatarUrl: true, countryCode: true, isPublic: true, level: true, elo: true } }, presence: { select: { lastHeartbeatAt: true, lastSeenAt: true } } } }
